...
/**
 * This is the item provider adapter for a {@link ac.soton.xmark.feedback.Feedback} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeedbackItemProvider extends NamedElementItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feedback_recipients_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feedback_recipients_feature", "_UI_Feedback_type"),
				 FeedbackPackage.Literals.FEEDBACK__RECIPIENTS,
				 true,
				 false,
				 false,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feedback_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feedback_title_feature", "_UI_Feedback_type"),
				 FeedbackPackage.Literals.FEEDBACK__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFeedbackPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feedback_feedback_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feedback_feedback_feature", "_UI_Feedback_type"),
				 FeedbackPackage.Literals.FEEDBACK__FEEDBACK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
