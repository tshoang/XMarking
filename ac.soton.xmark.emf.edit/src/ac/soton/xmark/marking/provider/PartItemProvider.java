...
/**
 * This is the item provider adapter for a {@link ac.soton.xmark.marking.Part} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_grade_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_grade_feature", "_UI_Part_type"),
				 MarkingPackage.Literals.PART__GRADE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MarkingPackage.Literals.PART__COMMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Part.class)) {
			case MarkingPackage.PART__GRADE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MarkingPackage.Literals.PART__COMMENTS,
				 MarkingFactory.eINSTANCE.createComment()));
	}
