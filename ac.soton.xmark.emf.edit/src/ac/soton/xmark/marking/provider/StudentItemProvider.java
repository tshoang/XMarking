...
/**
 * This is the item provider adapter for a {@link ac.soton.xmark.marking.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider extends RecipientItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_firstname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_firstname_feature", "_UI_Student_type"),
				 MarkingPackage.Literals.STUDENT__FIRSTNAME,
				 true,
				 false,
				 false,
	...
	protected void addLastnamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_lastname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_lastname_feature", "_UI_Student_type"),
				 MarkingPackage.Literals.STUDENT__LASTNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
