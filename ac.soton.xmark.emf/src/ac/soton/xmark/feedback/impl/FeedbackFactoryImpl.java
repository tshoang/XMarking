...
public class FeedbackFactoryImpl extends EFactoryImpl implements FeedbackFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FeedbackPackage.EXERCISE_FEEDBACK: return createExerciseFeedback();
	 ...
	 * @generated
	 */
	public ExerciseFeedback createExerciseFeedback() {
		ExerciseFeedbackImpl exerciseFeedback = new ExerciseFeedbackImpl();
