...
public class FeedbackAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeedbackSwitch<Adapter> modelSwitch =
		new FeedbackSwitch<Adapter>() {
			@Override
			public Adapter caseExerciseFeedback(ExerciseFeedback object) {
				return createExerciseFeedbackAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ac.soton.xmark.feedback.ExerciseFeedback <em>Exercise Feedback</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExerciseFeedbackAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ac.soton.xmark.feedback.Feedback <em>Feedback</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
