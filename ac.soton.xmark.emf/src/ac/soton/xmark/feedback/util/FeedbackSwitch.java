 ...
 */
package ac.soton.xmark.feedback.util;

import ac.soton.xmark.feedback.*;
...
public class FeedbackSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FeedbackPackage.EXERCISE_FEEDBACK: {
				ExerciseFeedback exerciseFeedback = (ExerciseFeedback)theEObject;
				T result = caseExerciseFeedback(exerciseFeedback);
				if (result == null) result = caseNamedElement(exerciseFeedback);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Exercise Feedback</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Exercise Feedback</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExerciseFeedback(ExerciseFeedback object) {
		return null;
	}
