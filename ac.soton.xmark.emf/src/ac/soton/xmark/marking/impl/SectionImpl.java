 ...
 * </p>
 * <ul>
 *   <li>{@link ac.soton.xmark.marking.impl.SectionImpl#getSubsections <em>Subsections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SectionImpl extends PartImpl implements Section {
	 ...
	 * @ordered
	 */
	protected EList<Part> subsections;
	...
	protected EClass eStaticClass() {
		return MarkingPackage.Literals.SECTION;
	}
	 ...
	 * @generated
	 */
	public EList<Part> getSubsections() {
		if (subsections == null) {
			subsections = new EObjectContainmentEList<Part>(Part.class, this, MarkingPackage.SECTION__SUBSECTIONS);
		}
		return subsections;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MarkingPackage.SECTION__SUBSECTIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MarkingPackage.SECTION__SUBSECTIONS:
				...
				getSubsections().addAll((Collection<? extends Part>)newValue);
				return;
		}
