...
public class MarkingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MarkingPackage.EXERCISE: {
				...
				if (result == null) result = caseNamedElement(exercise);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MarkingPackage.PART: {
			...
			case MarkingPackage.QUESTION: {
				...
				if (result == null) result = casePart(question);
			...
			case MarkingPackage.RECIPIENT: {
				Recipient recipient = (Recipient)theEObject;
				T result = caseRecipient(recipient);
				if (result == null) result = caseNamedElement(recipient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MarkingPackage.STUDENT: {
				...
				if (result == null) result = caseRecipient(student);
			...
			case MarkingPackage.GROUP: {
				...
				if (result == null) result = caseRecipient(group);
				if (result == null) result = caseNamedElement(group);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MarkingPackage.PART_GRADE: {
				PartGrade partGrade = (PartGrade)theEObject;
				T result = casePartGrade(partGrade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MarkingPackage.SECTION_GRADE: {
				SectionGrade sectionGrade = (SectionGrade)theEObject;
				T result = caseSectionGrade(sectionGrade);
				if (result == null) result = casePartGrade(sectionGrade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MarkingPackage.QUESTION_GRADE: {
				...
				if (result == null) result = casePartGrade(questionGrade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Part Grade</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Part Grade</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePartGrade(PartGrade object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Section Grade</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Section Grade</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSectionGrade(SectionGrade object) {
		return null;
	}
