 ...
 */
package ac.soton.xmark.feedback.validation;
...
public class FeedbackValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(FeedbackConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Feedback");
		if (section == null) {
			return dialogSettings.addNewSection("Feedback");
		}
		return section;
	}
}
